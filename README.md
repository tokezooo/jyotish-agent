...
[partial quick/inspection Codex smoke evidence](docs/release-codex-conversational-smokes-v1.json),
[partial held-out calculation/trust eval](docs/release-domain-adversarial-eval-v1.json), and
